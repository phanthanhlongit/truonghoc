    ...
    public class XMail
    {
        ...
        public static int senmail(string to, string subject,string body)
        {
            try
            {
                ...
                mailAuthentication.UserName = WebConfigurationManager.AppSettings["CredentialUserName"].ToString();
                mailAuthentication.Password = WebConfigurationManager.AppSettings["CredentialPassword"].ToString();
                System.Net.Mail.SmtpClient mailClient = new System.Net.Mail.SmtpClient(WebConfigurationManager.AppSettings["SMTPServer"].ToString(), 587);
